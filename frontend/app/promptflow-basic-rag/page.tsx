...
import { pf_score } from "@/actions/promptflow"
...
function extractAnswer(data: string): string {
    try {
    ...
    const handleChatSubmit = async (e: any) => {
        ...
        if (chatInput.trim() !== "") {
            ...
            try {
                ...
                const { output } = await pf_score(chatInput);
        ...
        <div className="flex flex-col ">
            <div className="flex-1 flex flex-col items-center bg-gradient-to-br from-primary to-secondary">
                <div className="max-w-2xl px-4 sm:px-6 lg:px-8 py-12 text-center">
                    <h1 className="text-4xl font-bold text-primary-foreground mb-4">Prompt Flow RAG</h1>
                    <p className="text-lg text-secondary-foreground mb-8">
                        Search for information about data that has been indexed.
                    </p>
